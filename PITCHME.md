...
@[9] (Let's skip the last iteration and go to the next one if we are at the 
		end of the array)
@[10] (We'll create a variable with our iterator + 1. This will stand for the element that's located immediately to the right of our iterator and will represent the right
element.)
